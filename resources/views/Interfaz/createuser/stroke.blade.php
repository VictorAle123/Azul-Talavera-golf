    ...
    <body id="page-top">
        ...
        <header style="background-color: #5CA4CE;" class="masthead text-white text-center">
            <div class="container d-flex align-items-center flex-column">
              ...
              <form action="{{route('stroke.store', $partidas)}}"  method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <table class="table">
                    ...
                    <tbody>
                       ...
                       <!-- Tabla  <form method="POST" action=""> -->
                        ...
                        <td><input  type="number" value="1" id="tentacles{{$i+1}}"  name="tentacles{{$i+1}}"
                        min="0" max="20" > </td>

                        <td><input type="number" value="1" id="juno{{$i+1}}"  name="tentacles"
                            min="1" max="20"></td>

                        <td><input type="number" value="1" id="jtres{{$i+1}}"  name="tentacles"
                                min="1" max="20"></td>

                                <td><input type="number" value="1" id="jcuatro{{$i+1}}"  name="tentacles"
                                    min="1" max="20"></td>
                  ...
                  <table class="table" >
                    ...
                    <tbody>
                        ...
                        <td><input type="number" value="1" id="v2uno{{$v+1}}"  name="v2uno{{$v+1}}"
                            min="0" max="20" > </td>

                        <td><input type="number" value="1" id="v2dos{{$v+1}}"  name="tentacles"
                                min="0" max="20" > </td>

                        <td><input type="number" value="1" id="v2tres{{$v+1}}"  name="tentacles"
                            min="0" max="20" > </td>

                        <td><input type="number" value="1" id="v2cuatro{{$v+1}}"  name="tentacles"
                            min="0" max="20" > </td>
